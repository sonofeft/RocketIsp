...
# -*- coding: utf-8 -*-
#
# RocketIsp documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'rocketisp','_version.py')
...
htmlhelp_basename = 'RocketIspdoc'
...
latex_documents = [
  (master_doc, 'RocketIsp.tex', u'RocketIsp Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'RocketIsp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RocketIsp', u'RocketIsp Documentation',
   author, 'RocketIsp', 'One line description of project.',
   'Miscellaneous'),
]
